...
- Dataset: `references/awwwards-sotd-2025.json` holds 200 Awwwards SOTD 2025 entries.
- Focus areas: keep the dataset clean, keep `.gitignore` and workflow docs current, and avoid breaking the preview UI.
- Current cleanup: dataset rename completed and verified locally; next step is expanding Awwwards to additional years before adding a new source.
- Last verified commit: `4ca8548`
