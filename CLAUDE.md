...
- UI note: advanced search is inline, results/detail/empty states use the archive shell, and feed/home keeps its original cinematic composition.
...
- Session anchor entering the selective regression fix: `00b587a`. Confirm the current tip from git instead of relying on this note alone.
